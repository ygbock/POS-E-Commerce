...
export const PERMISSIONS = {
  ...
  SETTINGS_VIEW:'settings.view', SETTINGS_UPDATE:'settings.update', AUDIT_VIEW:'audit.view', LOCATIONS_VIEW:'locations.view', LOCATIONS_MANAGE:'locations.manage',
  ...
  PLATFORM_VIEW:'platform.view', PLATFORM_TENANTS:'platform.tenants', PLATFORM_SUPPORT:'platform.support', PLATFORM_BILLING:'platform.billing', PLATFORM_DISCOVERY:'platform.discovery',
} as const;
...
export const ROLE_PERMISSIONS: Record<UserRole, string[]> = {
  ...
  inventory_manager: [PERMISSIONS.PRODUCTS_VIEW,PERMISSIONS.PRODUCTS_CREATE,PERMISSIONS.PRODUCTS_UPDATE,PERMISSIONS.INVENTORY_VIEW,PERMISSIONS.INVENTORY_ADJUST,PERMISSIONS.INVENTORY_TRANSFER,PERMISSIONS.INVENTORY_RECEIVE,PERMISSIONS.PURCHASES_VIEW,PERMISSIONS.PURCHASES_CREATE,PERMISSIONS.REPORTS_VIEW,PERMISSIONS.LOCATIONS_VIEW],
