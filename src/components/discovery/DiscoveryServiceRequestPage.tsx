...
export interface DiscoveryServiceRequestPageProps { serviceName?: string; serviceId?: string; onBack?: () => void; }

export const DiscoveryServiceRequestPage: React.FC<DiscoveryServiceRequestPageProps> = ({ serviceName, serviceId, onBack }) => {
