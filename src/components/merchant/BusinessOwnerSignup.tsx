...
export const BusinessOwnerSignup: React.FC = () => {
  ...
  return <div className="min-h-screen bg-slate-950 px-4 py-10 text-slate-900"><div className="mx-auto max-w-2xl">
    ...
    <form onSubmit={submit} className="rounded-3xl bg-white p-6 shadow-2xl sm:p-8">{error&&<div role="alert" className="mb-5 rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">{error}</div>}
